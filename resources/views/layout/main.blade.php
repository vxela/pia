...
<div class="d-flex">
    <div class="sidebar sidebar-dark bg-dark">
        <ul class="list-unstyled">
            ...
            <li><a href="{{'/preproduksi/simple'}}"><i class="fa fa-fw fa-plus"></i> Tambah Preproduksi</a></li><li><a href="{{'/preproduksi/simple'}}"><i class="fa fa-fw fa-plus"></i> Tambah Preproduksi</a></li>
