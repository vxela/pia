...
<nav class="navbar navbar-expand navbar-dark bg-danger">
    ...
    <div class="navbar-collapse collapse">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item" onclick="openFullscreen()"><span id="fullscreen" class="nav-link fullscreen"><i class="fa fa-arrows-alt"></i></span></li>
...
<div class="d-flex">
    <div class="sidebar sidebar-dark bg-dark">
        <ul class="list-unstyled">
            ...
            <li><a href="{{route('user.index')}}"><i class="fa fa-fw fa-table"></i> Data User</a></li>
            <li>
            ...
            <li><a href="{{route('admin.log_sistem')}}"><i class="fa fa-fw fa-tasks"></i> Log System</a></li>
            @yield('pagemenu')
